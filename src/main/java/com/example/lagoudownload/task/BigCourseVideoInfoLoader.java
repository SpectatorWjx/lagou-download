...
import com.example.lagoudownload.pojo.vo.PlayInfoVo;
...
import static com.example.lagoudownload.alibaba.AliyunApiUtils.getPlayInfoRequestUrl;
...
public class BigCourseVideoInfoLoader implements Runnable, NamedTask {
    ...
    public BigCourseVideoInfoLoader(String videoName, String courseId, String weekId, String dayId, String lessonId, String cookie) {
        ...
        try {
            if (ResourceType.RESOURCE.equals(this.type)) {
                if (this.resourceUrl != null) {
                    ...
                    ResourceLoader resourceLoader = new ResourceLoader(this.videoName, this.lessonId, this.weekId, this.resourceUrl, this.cookie);
                ...
                String strContent = HttpUtils.get(url, cookie).header("x-l-req-header", "{deviceType:1}").execute().body();
                ...
                String playInfoContent = HttpUtils.get(playInfoRequestUrl, cookie).header("x-l-req-header", "{deviceType:1}").execute().body();
