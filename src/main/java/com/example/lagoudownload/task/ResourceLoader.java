...
public class ResourceLoader implements Runnable, NamedTask, MediaLoader {
    ...
    public ResourceLoader(String videoName, String lessonId, String weekId, String resourceUrl, String cookie) {
    ...
    public void run() {
        try {
            if (this.resourceUrl!=null){
                HttpResponse httpResponse = HttpUtils.get(this.resourceUrl, this.cookie).header("x-l-req-header", " {deviceType:1}").execute(true);
