package com.example.lagoudownload.alibaba;
...
public class PlayAuth {
    ...
    //@JSONField(name = "AuthInfo",deserializeUsing = com.example.lagoudownload.decrypt.alibaba.PlayAuth.AuthInfo.AuthInfoDeserializer.class)
