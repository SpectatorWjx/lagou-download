...
import com.example.lagoudownload.constants.ResourceType;
import com.example.lagoudownload.constants.RespCode;
import com.example.lagoudownload.pojo.dto.BigCourseLessonDto;
import com.example.lagoudownload.pojo.vo.CourseDayInfoVo;
import com.example.lagoudownload.pojo.vo.CourseStageVo;
import com.example.lagoudownload.pojo.vo.LessonInfoVo;
import com.example.lagoudownload.pojo.vo.StageModuleVo;
import com.example.lagoudownload.task.BigCourseVideoInfoLoader;
...
public class BigCourseDownloader {
    ...
    public BigCourseDownloader(String courseId, String savePath, String cookie) {
    ...
    private int parseVideoInfo(List<BigCourseLessonDto> bigCourseLessonDtoList) {
        ...
        bigCourseLessonDtoList.forEach(lessonInfo -> {
            //TODO 取出课程名称
            if (!Mp4History.contains(cookie, lessonInfo.getLessonId(), lessonInfo.getLessonName(), courseId, null)) {
                BigCourseVideoInfoLoader videoInfoLoader = new BigCourseVideoInfoLoader(lessonInfo.getVideoName(), lessonInfo.getCourseId(), lessonInfo.getWeekId(), lessonInfo.getDayId(), lessonInfo.getLessonId(), cookie);
